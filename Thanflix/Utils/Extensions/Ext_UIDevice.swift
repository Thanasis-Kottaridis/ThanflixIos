...
//  Domain
//
//  Created by thanos kottaridis on 23/10/22.
//
...
public extension UIScreen {
    ...
    static public let pixelsPerInch: CGFloat? = {
        ...
        case "iPad3,1", "iPad3,2", "iPad3,3", "iPad3,4", "iPad3,5", "iPad3,6", "iPad4,1", "iPad4,2", "iPad4,3", "iPad5,3", "iPad5,4", "iPad6,7", "iPad6,8", "iPad6,3", "iPad6,4", "iPad6,11", "iPad6,12", "iPad7,1", "iPad7,2", "iPad7,3", "iPad7,4", "iPad7,5", "iPad7,6", "iPad7,11", "iPad7,12", "iPad8,1", "iPad8,2", "iPad8,3", "iPad8,4", "iPad8,5", "iPad8,6", "iPad8,7", "iPad8,8", "iPad8,9", "iPad8,10", "iPad8,11", "iPad8,12", "iPad11,3", "iPad11,4":
            return 264
            
        case "iPhone4,1", "iPhone5,1", "iPhone5,2", "iPhone5,3", "iPhone5,4", "iPhone6,1", "iPhone6,2", "iPhone8,4", "iPhone7,2", "iPhone8,1", "iPhone9,1", "iPhone9,3", "iPhone10,1", "iPhone10,4", "iPhone11,8", "iPhone12,1", "iPhone12,8", "iPod5,1", "iPod7,1", "iPod9,1", "iPad4,4", "iPad4,5", "iPad4,6", "iPad4,7", "iPad4,8", "iPad4,9", "iPad5,1", "iPad5,2", "iPad11,1", "iPad11,2":
            return 326
        ...
        case "iPhone10,3", "iPhone10,6",
         "iPhone11,2", "iPhone12,3", "iPhone11,4", "iPhone11,6", "iPhone12,5":
            return 458
...
// MARK: - Vibrate
public extension UIDevice {
    static func feedback_vibrate(withStyle style: UIImpactFeedbackGenerator.FeedbackStyle = .light) {
...
public extension UIDevice {
    ...
    static func findDeviceHeight() -> CGFloat {
        let screenRect = UIScreen.main.bounds
        let screenHeight = screenRect.size.height
        return screenHeight
    }
    
    static func doScaling() -> Bool {
