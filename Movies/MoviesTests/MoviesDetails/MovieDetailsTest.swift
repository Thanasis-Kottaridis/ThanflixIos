...
final class MovieDetailsTest: XCTestCase {
    ...
    func testFetchData() throws {
        ...
        var stateObserver: [MovieDetailsState] = []
        ...
        // initialze viewModel
        let viewModel = MovieDetailsViewModel(movieId: 1, actionHandler: mockActionHandler)
    ...
    func testFetchDataWithError() throws {
        ...
        // set mock repository Dependency.
        InjectedValues[\.moviesDataContext] = MockMoviesDataContext(isError: true)
